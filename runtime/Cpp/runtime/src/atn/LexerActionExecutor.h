...
namespace atn {
  ...
  public:
    LexerActionExecutor() = default;

    LexerActionExecutor(const LexerActionExecutor&) = default;

    LexerActionExecutor(LexerActionExecutor&&) = default;

    LexerActionExecutor& operator=(const LexerActionExecutor&) = default;

    LexerActionExecutor& operator=(LexerActionExecutor&&) = default;
    ...
    static LexerActionExecutor append(const LexerActionExecutor &lexerActionExecutor, AnyLexerAction lexerAction);
    ...
    std::optional<LexerActionExecutor> fixOffsetBeforeMatch(int offset) const;

    /// <summary>
    /// Gets the lexer actions to be executed by this executor. </summary>
    /// <returns> The lexer actions to be executed by this executor. </returns>
    const std::vector<AnyLexerAction>& getLexerActions() const;
  ...
  private:
    ...
    explicit LexerActionExecutor(std::vector<AnyLexerAction> lexerActions);

    std::vector<AnyLexerAction> _lexerActions;
  ...
  inline bool operator==(const LexerActionExecutor &lhs, const LexerActionExecutor &rhs) { return lhs.equals(rhs); }

  inline bool operator!=(const LexerActionExecutor &lhs, const LexerActionExecutor &rhs) { return !operator==(lhs, rhs); }
