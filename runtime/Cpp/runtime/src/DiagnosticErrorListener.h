...
namespace antlr4 {
  ...
  public:
    ...
    virtual void reportAttemptingFullContext(Parser *recognizer, const dfa::DFA &dfa, size_t startIndex, size_t stopIndex,
      const antlrcpp::BitSet &conflictingAlts, const atn::ATNConfigSet &configs) override;

    virtual void reportContextSensitivity(Parser *recognizer, const dfa::DFA &dfa, size_t startIndex, size_t stopIndex,
      size_t prediction, const atn::ATNConfigSet &configs) override;
  ...
  protected:
    ...
    virtual antlrcpp::BitSet getConflictingAlts(const antlrcpp::BitSet &reportedAlts, const atn::ATNConfigSet &configs);
  };
